 ...
 * @since 1.0
 * @deprecated since 1.3, use {@link org.apache.commons.clilda.Option#builder(String)} instead
 */
@Deprecated
public final class OptionBuilder
{
    ...
    private static int numberOfArgs = org.apache.commons.clilda.Option.UNINITIALIZED;
    ...
    private static void reset()
    {
        ...
        type = String.class;
        required = false;
        numberOfArgs = org.apache.commons.clilda.Option.UNINITIALIZED;
        optionalArg = false;
        valuesep = (char) 0;
    }
    ...
    {
        OptionBuilder.numberOfArgs = hasArg ? 1 : org.apache.commons.clilda.Option.UNINITIALIZED;
    ...
    {
        OptionBuilder.numberOfArgs = org.apache.commons.clilda.Option.UNLIMITED_VALUES;
     ...
     */
    public static org.apache.commons.clilda.Option create(char opt) throws IllegalArgumentException
    {
     ...
     */
    public static org.apache.commons.clilda.Option create() throws IllegalArgumentException
    {
        if (longopt == null)
        {
            OptionBuilder.reset();
     ...
     * a valid character.  See Option.
     */
    public static org.apache.commons.clilda.Option create(String opt) throws IllegalArgumentException
    {
        org.apache.commons.clilda.Option option = null;
        try
        {
            // create the option
            option = new org.apache.commons.clilda.Option(opt, description);
