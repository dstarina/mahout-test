 ...
 * file.
 */
public final class InternalVectorDumper extends AbstractJob {

  private static final Logger log = LoggerFactory.getLogger(InternalVectorDumper.class);

  public InternalVectorDumper() {
  }
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new Configuration(), new InternalVectorDumper(), args);
  }
